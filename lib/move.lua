...
m.goTo = function(position, moveOrder)
  _to(position, turtle.up, turtle.down, turtle.forward, nil, nil, nil, moveOrder)
end

-- dig to
m.digTo = function(position, moveOrder)
  _to(position, turtle.up, turtle.down, turtle.forward, turtle.digUp, turtle.digDown, turtle.dig, moveOrder)
end
