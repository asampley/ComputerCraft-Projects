-- Source: https://github.com/Possseidon/lua-midi
...
local midiEvent = {
  ...
  [0xE0] = function(stream, callback, channel, fb)
    ...
    callback("pitch", channel, bit.bor(lsb, bit.blshift(msb, 7)) / 0x2000 - 1)
    return 2
  end
}
...
local metaEvents = {
  ...
  [0x58] = function(data, callback)
    ...
    callback("timeSignature", numerator, bit.blshift(1, denominator), metronome, dotted)
  end,
